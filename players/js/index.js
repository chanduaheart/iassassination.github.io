var iAssassinationDb = [
    ...
    ["Chandan Kumar Mandal 💎", "sniper/pusher", "Inactive", "GEEKOFIA", 525601909],
    ["Mayank Jha", "sniper/pusher", "Inactive", "YunovonAmara", 541739948],
    ["Abhinav", "sniper/pusher", "Inactive", "Ankruz3", 581346056],
    ...
    ["AkelaBadshah", "sniper/pusher", "", "AkelaBadshah", 5222886852],
...
for (row = 0; row < iAssassinationDb.length; row++) {
    ...
    tableData.innerHTML += '<tr>' +
        ...
        '<td class="text-center"><span class="label label-success">' + iAssassinationDb[row][2] + '</td>' +
        '<td class="text-center">' + iAssassinationDb[row][3] + '</td>' +
        '<td class="text-center">' + iAssassinationDb[row][4] + '</td>' +
        '</tr>';
}
